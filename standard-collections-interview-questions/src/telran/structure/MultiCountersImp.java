...
public class MultiCountersImp implements MultiCounters {
...
private	TreeMap<Integer, HashSet<Object>> counters = new TreeMap<>();
	...
	private void moveItemCounters(Integer count, Object item) {
		if (count != 0) {
			removeCountresItem(count, item);
		}
		addCountresItem(count + 1, item);
		
	}

	private void addCountresItem(int counter, Object item) {
	...
	private void removeCountresItem(Integer count, Object item) {
